...
class Breakout_F767_v1:
    
    def __init__(self):

        self.port_1 = Port(DIO_A="PD5", DIO_B="PD6", POW_A="PD11", POW_B="PD13", POW_C="PD12", UART=2)
        self.port_2 = Port(DIO_A="PG2",DIO_B="PG3",POW_A="PB10",POW_B="PA6",POW_C="PB1")
        self.port_3 = Port(DIO_A="PC6", DIO_B="PC7", DIO_C="PB11", POW_A="PD8", POW_B="PC5", UART=6)
        self.port_4 = Port(DIO_A="PB8", DIO_B="PB9", DIO_C="PA5", POW_A="PB2", POW_B="PF5", DAC=2, I2C=1)
        self.port_5 = Port(DIO_A="PC9", DIO_B="PC8", DIO_C="PA7", POW_A="PF4", POW_B="PE8")
        self.port_6 = Port(DIO_A="PC4", DIO_B="PA2", DIO_C="PA3", POW_A="PE7", POW_B="PD14")
        self.port_7 = Port(DIO_A="PF10", DIO_B="PE12", DIO_C="PE9", POW_A="PE10", POW_B="PD15")
        self.port_8 = Port(DIO_A="PF14", DIO_B="PF15", DIO_C="PA4", POW_A="PE14", POW_B="PE15", DAC=1, I2C=4)
        self.port_9 = Port(DIO_A="PG14", DIO_B="PE0", POW_A="PE13", POW_B="PE11", UART=8)
        self.port_10 = Port(DIO_A="PG11", DIO_B="PG6", POW_A="PF13", POW_B="PF12", POW_C="PF3")
