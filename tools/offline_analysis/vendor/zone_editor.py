...
from tools.offline_analysis.vendor.numeric_line_edit import NumericLineEdit
...
def _palette_hex() -> list[str]:
    try:
        from tools.offline_analysis.vendor.zone_overlay import ZONE_COLORS_BGR
...
class ZoneEditorWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, setup_id=None, get_frame_callback=None,
        ...
        if initial_zones_path:
            try:
                from tools.offline_analysis.vendor.zone_io import load_zone_config
