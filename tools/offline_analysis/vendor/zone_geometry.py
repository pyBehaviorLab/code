...
# The rig reaches for a Cython accelerator here (source.cython.zone_math).
# That is the one import that would tie this copy back to the rig, and the
# pure-Python path below is what the rig itself falls back to when Cython is
# not compiled. Named in the drift guard's EXPECTED_DIFFERENCES rather than
